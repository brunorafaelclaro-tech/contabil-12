// Módulo: Aba Import - Despesa
// Fornece funções específicas para processar importações do tipo 'Despesa'.
(function(){
    const mod = {};
    ...
    mod.handleFileInput = function(app, input) {
        ...
        reader.onload = (e) => {
            try {
                ...
                console.error('Erro lendo arquivo (AbaImportDespesa):', err);
    ...
    mod.processFinancialData = function(app, rows) {
        // Reuso do comportamento existente para 'Receita'/'Despesa' com foco em 'Despesa'
        app.tempData = [];
